...
export class InitialSchema1785925251672 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`products\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`description\` varchar(255) NULL, \`price\` decimal(10,2) NOT NULL, \`discountPercent\` int NOT NULL DEFAULT '0', \`image\` varchar(255) NULL, \`gallery\` json NULL, \`isAvailable\` tinyint NOT NULL DEFAULT 1, \`stockMode\` varchar(10) NOT NULL DEFAULT 'count', \`stock\` int NOT NULL DEFAULT '0', \`categoryId\` int NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
