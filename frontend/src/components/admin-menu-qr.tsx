...
export function AdminMenuQr() {
  ...
  return (
    <main className="mx-auto max-w-7xl">
      ...
      <section className="grid gap-6 rounded-2xl border border-stone-200/70 bg-white p-6 shadow-[0_1px_3px_rgba(0,0,0,0.04)] lg:grid-cols-[320px_1fr]">
        <div className="flex justify-center">
          {qrDataUrl ? (
            ...
            <img
              ...
              className="h-72 w-72 rounded-2xl border border-stone-200 bg-white p-3"
            />
          ) : (
            <div className="grid h-72 w-72 place-items-center rounded-2xl border border-dashed border-stone-300 text-sm text-stone-400">
              Generating...
            </div>
          )}
        </div>
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="mt-4 break-all rounded-xl border border-stone-200/70 bg-stone-50 px-4 py-3 text-sm font-medium text-stone-800">
          ...
          <p className="mt-3 max-w-xl text-sm leading-relaxed text-stone-500">
            ...
            customer-facing menu experience at <span className="font-medium text-stone-700">/menu</span>.
          </p>
        </div>
      </section>
    </main>
