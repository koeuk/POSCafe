...
/**
 * Customer-facing product detail. The server page fetches the product and
 * hands it over as plain data; this client component owns the visible text so
 * it can be translated with useT().
 */
export function MenuProductDetail({ product }: { product: Product }) {
  const { t } = useT();
        ...
        <div className="overflow-hidden bg-white shadow-sm lg:grid lg:grid-cols-2 lg:rounded-3xl">
          ...
          <div className="px-5 pb-16 pt-6 lg:flex lg:flex-col lg:p-10">
            ...
            <p className="mt-10 text-center text-xs text-stone-400 lg:mt-auto">
              {t("Ask our staff to place your order")}
            </p>
          </div>
        </div>
      </div>
