      ...
      <div className={`mb-6 flex flex-wrap items-end justify-between gap-3 rounded-2xl px-5 py-5 ${GLASS}`}>
        ...
        <div className="flex items-center gap-2">
          <select
            ...
            className="cursor-pointer rounded-lg border border-stone-200 bg-white px-3 py-2 text-sm font-medium text-stone-700 outline-none transition focus:border-pos-button focus:ring-2 focus:ring-pos-button/15 dark:border-stone-700 dark:bg-stone-800 dark:text-stone-200"
          >
            {PERIODS.map((p) => (
